...
import marioTilemap from "../public/assets/tilemaps/maps/super-mario.json";
...
class Example extends Phaser.Scene {
  ...
  preload() {
    this.load.image("ship", "../public/assets/sprites/fmship.png");
    this.load.image(
      "tiles1",
      "../public/assets/tilemaps/tiles/super-mario.png"
    );
    this.load.tilemapTiledJSON({ key: "map", url: marioTilemap });
  }
